...
- Global memory set (compact): `Heartloom-Identity/Policies/AI/global-memories-refactored-set-v2.0.md`
- Required reference list: `Heartloom-Identity/Policies/AI/required-reference-docs.md`
- Policy pack index: `Heartloom-Identity/Policies/AI/heartloom-ai-policy-index-v1.0.md`
...
This constitution intentionally avoids duplicating full policy text. Operational details live in the policy pack (`Policies/AI/`).
